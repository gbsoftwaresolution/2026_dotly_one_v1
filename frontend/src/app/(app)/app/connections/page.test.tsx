...
async function renderPage() {
  ...
  return render(
    <IdentityProvider initialIdentities={identities}>{element}</IdentityProvider>,
  );
}

describe("AppConnectionsPage", () => {
  beforeEach(() => {
  ...
  it("requires the app connections session path and renders the list", async () => {
