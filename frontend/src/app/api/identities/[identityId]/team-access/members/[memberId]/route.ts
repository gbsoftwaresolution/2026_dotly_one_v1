...
export async function PUT(
  ...
  {
    params,
  }: { params: Promise<{ identityId: string; memberId: string }> },
) {
  ...
  try {
    ...
    const response = createRouteErrorResponse(
      error,
      "Unable to update member assignments right now.",
    );
