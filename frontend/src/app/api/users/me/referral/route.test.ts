...
describe("GET /api/users/me/referral", () => {
  it("returns the proxied referral code for the authenticated session", async () => {
    ...
    expect(mocks.apiRequest).toHaveBeenCalledWith("/users/me/referral", {
      token: "token",
    });
  });
