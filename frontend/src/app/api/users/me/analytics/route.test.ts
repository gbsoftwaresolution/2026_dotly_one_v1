...
describe("GET /api/users/me/analytics", () => {
  it("returns the proxied analytics payload for the authenticated session", async () => {
    ...
    expect(mocks.apiRequest).toHaveBeenCalledWith("/me/analytics", {
      token: "token",
    });
  });
